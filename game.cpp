...
int SDL_ToggleFS(SDL_Window *win, Level *level) {
  ...
  // NOTE: SDL_SetWindowFullscreen takes FLAGS as the second param, NOT
  // true/false!
    ...
    while (SDL_PollEvent(&event) != 0) {
      ...
      case SDL_MOUSEBUTTONDOWN:
        ...
        default:
          ...
          // SDL_ShowSimpleMessageBox(0, "Mouse", "Some other button was
          // pressed!", window);
          break;
        }
        break;
      ...
      case SDL_MOUSEMOTION:
        ...
        level.handle_mouse(-event.motion.xrel / 1000.0f,
      ...
      case SDL_KEYDOWN:
        ...
        case SDLK_f:
          SDL_ToggleFS(mainwindow, &level);
          break;
        case SDLK_b:
          b2.new_text("asdas dasd adasdas dasda sdasd asdasd asda sdasd asd "
                      "adasd asda dasdas dasd asdasd asd a");
          break;
        case SDLK_a:
          level.handle_key_down(LEFT);
          break;
        case SDLK_d:
          level.handle_key_down(RIGHT);
          break;
        case SDLK_w:
          level.handle_key_down(UP);
          break;
        case SDLK_s:
          level.handle_key_down(DOWN);
          break;
        case SDLK_k:
          level.handle_key_down(ATTACK1);
          break;
        case SDLK_SPACE:
          level.handle_key_down(SPACE);
          break;
        }
        break;
      case SDL_KEYUP:
        switch (event.key.keysym.sym) {
        case SDLK_a:
          level.handle_key_up(LEFT);
          break;
        case SDLK_d:
          level.handle_key_up(RIGHT);
          break;
        case SDLK_w:
          level.handle_key_up(UP);
          break;
        case SDLK_s:
          level.handle_key_up(DOWN);
          break;
        case SDLK_k:
          level.handle_key_up(ATTACK1);
          break;
        case SDLK_SPACE:
          level.handle_key_up(SPACE);
          break;
        }
        break;
      case SDL_QUIT:
